...
On Error Resume Next
 If Te1 = "" Then Te1.SetFocus: Exit Sub
If MsgBox("真的要删除 [" & Dir(Te1, vbHidden Or vbSystem) & "] 吗？", vbExclamation + vbSystemModal + vbYesNo) = vbYes Then
  If Dir("c:\SettKFs\") = "" Then MkDir "c:\SettKFs\"
  FileCopy Te1, "c:\SettKFs\" & Dir(Te1, vbHidden Or vbSystem)
  Kill Te1: Te1 = ""
End If
If Err Then MsgBox "删除失败！请查找原因，然后再试一次。", vbSystemModal + vbCritical
End Sub
